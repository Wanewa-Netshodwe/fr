        ...
        <div className="px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="text-sm">
              ...
              <p className="text-xs text-gray-500">Session: 1h 23m</p>
            </div>
            <Button
              variant="outline"
              size="sm"
          ...
          <div className="p-4">
            ...
            >
              <TabsList className="grid w-full grid-cols-1 gap-1 bg-gray-50 p-1 h-auto">
                ...
                <TabsTrigger value="tickets" className="justify-start w-full">
                ...
                <TabsTrigger value="sensors" className="justify-start w-full">
                  <Activity className="h-4 w-4 mr-2" />
                  Sensor Management
                </TabsTrigger>
                <TabsTrigger value="sensormap" className="justify-start w-full">
          ...
          <Tabs value={activeTab} className="w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Progress value={metrics.compliantRate} className="mt-2" />
                  </CardContent>
                </Card>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-700">
                            Marabastad Car Wash #247 - Possible leak
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-orange-700">
                            Hammanskraal Operators - 3 facilities affected
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-700">
                            Unauthorized water usage reported in Soshanguve
                          </p>
                        </div>
                      </div>
                      <Button size="sm" variant="outline">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center text-blue-600">
                            ...
                            <p className="font-medium">
                              Tshwane Sensor Network
                            </p>
                            <p className="text-xs opacity-75">
                              8 IoT sensors monitoring water usage
                            </p>
                          </div>
                        </div>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-500">
                    Enforcement management interface would be implemented
                    here...
                  </p>
                </CardContent>
              </Card>
            ...
            <TabsContent value="reports">
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-500">
                    Analytics and reporting interface would be implemented
                    here...
                  </p>
                </CardContent>
              </Card>
